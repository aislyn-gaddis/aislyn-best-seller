...
if (file.exists(data_file)) {
  ...
  last_date <- as.Date("2011-02-13")  # 🔧 Change this if your start date is different
}
...
if (next_sunday > last_date) {
  ...
  if (length(titles) > 0) {  # Only save if scrape was successful
    ...
    write_csv(bestsellers_updated, "data-processed/bestsellers-combined.csv")
    
    print("Combined bestsellers updated successfully.")
  } else {
