...
- What authors have had the most books on the the list this year? last 2 years? 5 years? 10 years?
...
bestsellers |> # start with the data
  ...
  summarize(appearances = n()) |> # count appearances per author
  arrange(desc(appearances)) |> # arrange in descending order by appearances
  filter(appearances > 65) # only include appearances above 65
```
...
## What author has had the most books on the list?

It's Danielle Steel with 136.
